...
def get_llm_content() -> str:
    ...
    if(np.random.random() < 0.85):
        ...
        style_selection = [
            "铭文风格，参考先秦时期器物上的铭文，简约古拙，多使用“唯”、“其”等古语，庄重肃穆。",
            "诗经风格，类似诗经的诗句，每句均为严格的四字，质朴自然，富有韵律感，带有比兴手法，多提及自然景物，生活气息浓厚。",
            "律令风格，如秦代法律条文或官方诏书，严谨、精确、冷峻，充满权威感和秩序感。",
            "耕战风格，使用秦代文言文，务实、粗犷，反映庶民与士兵的视角，用语直接有力",
            "辞赋风格，按照汉代辞赋格式，语言类似《洛神赋》，句式严格对仗，铺陈华丽，气势恢宏，善用排比与典故，词汇丰富绚烂，充满浪漫与想象。",
            ...
            "诗豪风格，五言或七言唐诗体裁，如李白、李贺的诗歌，自信奔放，意境开阔，色彩浓烈，充满奇特的想象和磅礴气势。",
            "禅意风格，类似王维、寒山的诗句，空灵含蓄，言简意赅，追求意境深远，带有佛道哲学的韵味。",
            "婉约风格，按照宋词牌格式，婉约、精致、意象密集，善于描绘内心细腻的情感与景物，格局内敛，追求艺术化的表达。",
            "豪放风格，按照宋词牌格式，追求豪放奔放的气势，仿陆游诗文沉雄感，善于描绘壮丽景象，格局开阔，显家国情怀。",
        ...
        era_selection = ["史前", "2277年", "魔法时代", "水底世界", "末世", "蒸汽朋克大明", 
                         "东方志怪(现代都市与东方妖鬼精怪共存的世界)", 
                         "万物有灵(所有物体都拥有情感与记忆,城镇化水平不高)"]
        style_selection = [
            ...
            "机巧辞赋风格，以古典赋文的华丽辞藻描绘机械造物，充满东方古典与工业奇想的融合之美。",
            "匠册风格，如同古代工程手册的笔录，用语精准、务实，夹杂着工匠黑话和实测数据，朴实中见巧思。",
            "志怪风格，现代文，笔调冷峻奇诡，如同《聊斋》或《子不语》。在描述现代物品时赋予其妖异、神秘的特性，营造出抽离现实的诡异感。",
            "都市传说风格，以现代都市人的口吻讲述不可思议的见闻。语言贴近生活却暗藏玄机，如同朋友间分享的诡异经历，真实与虚构的界限模糊。",
            "灵语风格，古老、诗意而缓慢。语言充满通感，物品的叙述视角宏大，与自然和时空紧密相连。",
            "物语风格，以物品本身作为第一人称（忽略不使用第一人称限制），语言天真、好奇或带着岁月的絮叨，充满主观感受和细微的感知，生动而拟人化。",
        ]
        era_index = np.random.randint(0, len(era_selection))
        era = era_selection[era_index]
        style = style_selection[era_index * 2 + np.random.randint(0, 2)]
    ...
    if(np.random.random() < 0.7):
        ...
        typ = "生成一项你从" + np.random.choice(["父母", "朋友", "邻居", (("子女" if (age > 44) else "配偶") if (age > 22) else "长辈")]) + "获得的物品"
    ...
    role：你的具体职业（具体而简短，8字以内），该职业类型属于''' + role + '''
